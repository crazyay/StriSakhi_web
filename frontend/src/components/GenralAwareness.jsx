...
import { data } from '../API/GenralAwarenessData'; // Adjust the path as necessary
import styles from '../compoCSS/HealthyTeen.module.css';

const GenralAwareness = () => {
...
export default GenralAwareness;
